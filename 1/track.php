...
<html>
<head>
<title>XLLDeal | Track Order</title>
<!-- for-mobile-apps -->
...
<div class="progress">
  ...
  <?php
       switch ($GlobalData['current_status']) {
        ...
        case 'Shipped':
         echo "
         <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow='65' aria-valuemin='0' aria-valuemax='100' style='width:0%'></div>
         ";
          break;

        case 'Ready To Shipped':
         echo "
         <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow='38' aria-valuemin='0' aria-valuemax='100' style='width:0%'></div>
         ";
          break;
...
<div class="col-sm-12" style="border:1px solid #cfcfcf; padding:10px; border-radius: 6px;">
	<h5>Order ID : #ORDXLL<?php echo $GlobalData['order_id'] ; ?><br/>
	Order On : <?php echo $GlobalData['date']." ".$GlobalData['time'] ; ?><br/>
	Shipping Address : <?php echo $GlobalData['address'] ; ?><br/>
	<?php 
		if($GlobalData["current_status"]!="Delivered" && $GlobalData["current_status"]!="Cancelled")
			{
	?>
	Cancel Order:- <p id='test'><a  class="btn btn-danger" href="cancelorder.php?id=<?php echo $GlobalData['order_id']?>"><span  aria-hidden="true"></span>Cancel Order</a></p>
	<?php 
		}
		else
		{
	?>
		Cancel Order:-<button class="btn btn-danger" type="button" disabled>Cancelled</button>
