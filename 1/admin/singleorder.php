...
?>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="pendingorder.php"><strong>#ORDERXLL<?php echo base64_decode($_GET['orderid']); ?></strong> Order</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner homepage-box">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-th"></i> Order For <strong>#ORDERXLL<?php echo base64_decode($_GET['orderid']); ?></strong></h2>
            ...
            <div class="box-content">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><a href="#info"><strong>#ORDERXLL<?php echo base64_decode($_GET['orderid']); ?></strong></a></li>
                </ul>
