            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="faq.php"><i class="glyphicon glyphicon-eye-open"></i><span> FAQ Questions</span></a>
                        </li>
                        <li><a class="ajax-link" href="cod.php"><i
                                    class="glyphicon glyphicon-globe"></i><span> COD Setup</span></a></li>

                        <li class="nav-header hidden-md">Coupon Managment</li>
                            <li><a class="ajax-link" href="coupon.php"><i
                                    class="glyphicon glyphicon-ok-circle"></i><span>All Coupons</span></a></li>
