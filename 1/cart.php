...
<table class="table table-hover table-condensed" style="max-width: 70%; margin-left: 15% ">
	...
	<tbody>
		<?php $bool=viewcartitem(); 
			$_SESSION['totamt']=$bool[1];

		?>
	</tbody>
</table>
<form action='#' method='post'>
						<div align='center'><th>PromoCode</th><input type='text' name='coupon'   width='50%'>
						<button type='submit' name='btnapply' class='btn btn-default'>apply</button>
						</div>
						</form>
<div class="">
<p align="center">
...
<?php if($bool[0]==true)
{
	...
	echo "<a href='checkout.php' class='btn btn-success'> &nbsp; &nbsp; <span class='glyphicon glyphicon-menu-right' aria-hidden='true'></span> CheckOut &nbsp; &nbsp; </a>";
	}
	if(!isset($_SESSION['UserEmail']))
